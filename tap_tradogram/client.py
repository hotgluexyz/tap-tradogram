"""REST client handling, including TradogramStream base class."""
...
class TradogramStream(RESTStream):
    """Tradogram stream class."""
    ...
    def http_headers(self) -> dict:
        ...
        """
        headers = {}
        headers["User-Agent"] = self.config.get("user_agent", "tap-tradogram")
